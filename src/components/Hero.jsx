    ...
    return (
        <div className='text-white' id='hero'>
            <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <a href="/danush_sainadh_reddy_dumpa resume.pdf" download="Resume.pdf" className='bg-[#00df9a] flex items-center justify-evenly text-black rounded-lg w-[180px] py-2 text-center font-medium mx-auto my-5 hover:cursor-pointer'>Download My CV <IoMdCloudDownload size={25}/></a> 
